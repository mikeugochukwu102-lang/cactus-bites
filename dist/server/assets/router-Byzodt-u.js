...
const appCss = "/assets/styles-ULuwd0eL.css";
...
const Route$2 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "Cactus Restaurant — Waterfront Dining in Victoria Island, Lagos" },
      { name: "description", content: "A waterfront sanctuary on Ozumba Mbadiwe Ave. Multi-cuisine fine dining with lagoon views in Victoria Island, Lagos." },
      { name: "author", content: "Cactus Restaurant" },
      { property: "og:title", content: "Cactus Restaurant — Waterfront Dining in Lagos" },
      { property: "og:description", content: "Multi-cuisine fine dining with lagoon views on Victoria Island." },
...
const $$splitComponentImporter$1 = () => import("./admin-BrUf2gR5.js");
const Route$1 = createFileRoute("/admin")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component"),
  head: () => ({
    meta: [{
      title: "Cactus — Gallery Admin"
    }, {
      name: "robots",
      content: "noindex"
    }]
...
const $$splitComponentImporter = () => import("./index-oAccxeqO.js");
